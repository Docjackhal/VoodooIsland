...
--
-- Client :  localhost
-- Généré le :  Sam 19 Août 2017 à 16:54
...
INSERT INTO `VI__parametresEvenements` (`ID`, `TitreFR`, `DescriptionFR`, `TypeRegion`, `Poids`, `Condition1_Type`, `Condition1_ValeurA`, `Condition1_Operateur`, `Condition1_ValeurB`, `Condition2_Type`, `Condition2_ValeurA`, `Condition2_Operateur`, `Condition2_ValeurB`) VALUES
(1, 'Un truc qui brille', 'Vous observez un scintillement sur le sable. En vous rapprochant, vous découvrez une vieille pelle en acier à moitié enterrée.', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'La vieille marmitte', 'En fouillant dans le sable, vous déterrez une vieille marmite. Elle semble intacte et vous permettra de faire la cuisine dans votre futur campement.', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 1, 1, 'n', 10, 10, 10, 10, 10, 10, 6, 6, 4, 4, 4, 4, 5, '2017-08-13 15:13:47'),
